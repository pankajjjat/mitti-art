        ...
        <div className="container-page">
          <div className="mx-auto flex max-w-lg flex-col items-center text-center">
            ...
            <p className="mt-4 font-sans text-base leading-relaxed text-text-muted">
              Thank you, {form.name}! We&rsquo;ve opened your email client with
              the details. Send the email and we&rsquo;ll get back to you within
              24-48 hours.
            </p>
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 block w-full rounded-lg border border-border bg-page px-4 py-3 font-sans text-sm text-text placeholder:text-text-muted/60 transition-colors focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <select
                  ...
                  value={form.artType}
                  onChange={handleChange}
                  className="block w-full appearance-none rounded-lg border border-border bg-page px-4 py-3 pr-10 font-sans text-sm text-text transition-colors focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
                >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="mt-1.5 block w-full rounded-lg border border-border bg-page px-4 py-3 font-sans text-sm text-text placeholder:text-text-muted/60 transition-colors focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent resize-y"
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  value={form.budget}
                  onChange={handleChange}
                  className="mt-1.5 block w-full rounded-lg border border-border bg-page px-4 py-3 font-sans text-sm text-text transition-colors focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
                >
